...
export class Migration20240301082721_initial extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "giz_user" ("id" uuid not null default uuid_generate_v4(), "created_at" timestamp not null default now(), "updated_at" timestamp not null default now(), "version" int not null default 1, "email" varchar(255) not null, "first_name" varchar(255) null, "last_name" varchar(255) null, "password" varchar(255) not null, "salt" varchar(255) not null, "email_verified" boolean not null default false, "verification_code" varchar(6) null, "verification_expires_at" timestamptz null, "two-factor_enabled" boolean null default false, "two-factor_secret" varchar(255) null, constraint "giz_user_pkey" primary key ("id"));');
